...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/raspicameradaemon

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/raspicameradaemon: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/raspicameradaemon ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/src/camera-list.o: src/camera-list.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/camera-list.o src/camera-list.c

${OBJECTDIR}/src/camera-utils.o: src/camera-utils.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/camera-utils.o src/camera-utils.c
...
${OBJECTDIR}/src/logging.o: src/logging.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/logging.o src/logging.c
...
${OBJECTDIR}/src/rcd-controller-protocol.o: src/rcd-controller-protocol.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/rcd-controller-protocol.o src/rcd-controller-protocol.c
...
${OBJECTDIR}/src/usb_device.o: src/usb_device.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/usb_device.o src/usb_device.c
